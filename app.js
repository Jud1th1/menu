...
filterBtns.forEach(function(btn){
  btn.addEventListener("click", function(e){
    ...
    const menuCategory = menu.filter(function(menuItem){
      //set up if else for menu categories 
      if(menuItem.category === category){
        return menuItem;
      }
    });
    //set up a all category (since it is not listed with the menu items)
    if(category === "all"){
...
function displayMenuItems(menuItems){
   //use map method and assign a variable
  ...
  //next join them in one string to place them in section-center html
